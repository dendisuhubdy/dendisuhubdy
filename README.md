...
- ⭐ **[blaze](https://github.com/dendisuhubdy/blaze)** - C++ HPC Math Library
- ⭐ **[dark_pool](https://github.com/dendisuhubdy/dark_pool)** - Dark Pool matching engine in C++
- ⭐ **[quanttrade](https://github.com/dendisuhubdy/quanttrade)** - Quantitative Trading Library
- ⭐ **[liquibook](https://github.com/dendisuhubdy/liquibook)** - Order Book implementation with CMake build system
- ⭐ **[vfae](https://github.com/dendisuhubdy/vfae)** - Variational Fair Autoencoder (Research)
- ⭐ **[fix_server](https://github.com/dendisuhubdy/fix_server)** - Order Management System

## Publications

[Google Scholar](https://scholar.google.com/citations?user=x3M1yCQAAAAJ&hl=en&oi=ao)

- 📄 **ChatPainter: Improving Text to Image Generation using Dialogue** (2018)
  Shikhar Sharma, **Dendi Suhubdy**, Vincent Michalski, Samira Ebrahimi Kahou, Yoshua Bengio
  [[arXiv]](https://arxiv.org/abs/1802.08216)

- 📄 **Fraternal Dropout** (2018) — *ICLR 2018*
  Konrad Zolna, Devansh Arpit, **Dendi Suhubdy**, Yoshua Bengio
  [[arXiv]](https://arxiv.org/abs/1711.00066)
...
- 📄 **A Deep Reinforcement Learning Chatbot** (2017)
  ...
  [[arXiv]](https://arxiv.org/abs/1709.02349)
...
📧 dendi.suhubdy@pm.me
🔗 [LinkedIn](https://linkedin.com/in/dendisuhubdy) · [Medium](https://dendisuhubdy.medium.com/) · [ResearchGate](https://www.researchgate.net/profile/Dendi-Suhubdy)
